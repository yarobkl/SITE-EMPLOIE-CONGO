...
const LEGAL_PAGES = {
  privacy: {
    ...
    sections: [
      ...
      ['Annonces immobilières', 'Nzela traite les informations des logements publiés, leurs photos, leur ville, leur quartier, leur prix, leurs équipements, leur durée de disponibilité, les coordonnées rendues publiques par l’auteur, les favoris, les signalements et les demandes de contact ou de visite. Un identifiant aléatoire pseudonyme sert à compter une vue unique sans révéler au propriétaire l’identité des visiteurs. Les photos des annonces publiées sont accessibles publiquement ; les autres coordonnées et les messages restent soumis aux contrôles d’accès.'],
