...
export default function App() {
  ...
  const renderScreen = () => {
    ...
    return <HomeScreen jobs={filteredJobs.slice(0, 3)} totalJobs={publishedJobs.length} query={query} setQuery={setQuery} city={city} setCity={setCity} clearSearch={clearSearch} openJob={openJob} setScreen={setScreen} openLogin={openLogin} savedIds={savedIds} toggleSave={toggleSave} isLoggedIn={isLoggedIn} profileRole={profile.role} />;
  };
  ...
  const platformSections = {
    home: wrapPlatformMain(
      mobileActiveSection === 'home'
        ? renderScreen()
        : <HomeScreen jobs={filteredJobs.slice(0, 3)} totalJobs={publishedJobs.length} query={query} setQuery={setQuery} city={city} setCity={setCity} clearSearch={clearSearch} openJob={openJob} setScreen={setScreen} openLogin={openLogin} savedIds={savedIds} toggleSave={toggleSave} isLoggedIn={isLoggedIn} profileRole={profile.role} />,
    ),
...
function HomeScreen({ jobs, totalJobs, query, setQuery, city, setCity, clearSearch, openJob, setScreen, openLogin, savedIds, toggleSave, isLoggedIn, profileRole }) {
